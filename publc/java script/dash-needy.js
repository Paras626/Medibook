...
//window.location.replace("/profile-needy.html"); // new thing
location.href="profile-needy.html";
})
//======================================================need to do
$("#need").click(function(req,resp){
//window.location.replace("/needy-med-search.html"); // new thing
location.href="needy-med-search.html";
})
//=========================================================
...
$("#profile").mouseenter(function(){
    $("#div1 img").css("transform","rotate(180deg)");
})
$("#profile").mouseleave(function(){
    $("#div1 img").css("transform","rotate(360deg)");
})
$("#opwd").blur(function () {
var x = $(this).val();
var r = /(?=^.{8,}$)(?=.*\d)(?=.*[!@#$%^&*]+)(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$/;
